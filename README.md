...
* Degree in Computer Systems |
  Qualification by Professional Experience | SEP
  In Process since 2019
  
* Technnical Developer | 
  Colegio Bilingüe Profr. Zeferino Aguirre |
  SEP 1987 - JUN 1990

# Certifications
* Azure Fundamentals Microsoft [📛](https://www.credly.com/badges/fccd9311-f137-4ad7-8113-ade94216396e)
* Scrum Foundation Professional CertiProf [📛](https://www.credly.com/badges/1a9d1d90-7ef0-4e70-bdfa-323d3e762a9f)
* Remote Work and Virtual Collaboration CertiProf [📛](https://www.credly.com/badges/04911ddc-263e-44b9-b194-1a52bfe7e077)
* Survey Contributor of The Agile Adoption Report 2021 CertiProf [📛](https://www.credly.com/badges/236b07d3-daf1-4baa-876f-8e7a186b72bd)
* Lifelong Learning CertiProf [📛](https://www.credly.com/badges/ad34e408-2a6b-4960-9d58-5adbad1fc2bc)
...
* RUP
## Other knowledges
* Structured Cabling Cat5, 5e and 6 UTP, QoS, Wireless Network protocol IEEE 802.11b
* Video and Data over IP (SIP Servers)
* Communication protocols: IP, TCP, Netware, IPX, NetBEUI, FTP, HTTP, HTTPS
* Network Configuration Lan, Wan and Man
* Windows Servers Configuration and Administration (IIS, FTP, SMTP, Active Directory, DNS)
* Linux (Apache, Firewall, IP Tables, FTP, Tomcat)
...
* Methologies and frameworks 
* Management of Standars
...
- Development in process, system named [🌐Comidas Del Angel](www.comidas-delangel.tk)[🌐Delivery](www.comidas-delangel.tk/app), with Clean Architecture & SOLID, Back: API/REST, SQL Server 2019, Entity Framework with Unit of Work; Front: MVC, Angular 10, Bootstrap 5, Font Awesome 5, design based on template theme; Mobile: Xamarin Forms 5.0 for Android & iOS, MVVC with Autofact for Dependency Injection and MediatR for Clean Architecture.
- Hosting and Development of Comprehensive Service System, with ASP.NET Core 2.1, MVC, Entity Framework, ASPI / REST Services, Bootstrap, jQuery and SQL Server as Database for Grupo Integralli [🌐Grupo Integralli](www.grupointegralli.com.mx).
...
**Federación Mexicana de Fútbol - Backend Developer Sr.**

***August 2018 - October 2018***
- Node Js, Angular Js, jQuery, Sequelize, web services API/REST with SQL Server 2016

**Manpower – Banamex Accival - Developer SSr.**
...
## Kneos Tecnologías de Colaboración Empresarial, SA de CV
...
## Pagoza Urbanizadores y Constructores, SA de CV
*NOVEMBER 2001 - JUNE 2004*

**Chief Manager of Satellital Tracking** 

- Personnel Management 6 people in charge with rotation of schedules
- Area Budget and Resource Management
- Vehicle location was carried out via satellite with 100 units protected to cover 7/24 (7 days x 24 hours).
